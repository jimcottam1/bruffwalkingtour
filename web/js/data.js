/**
 * AUTO-GENERATED from data/waypoints.yaml — edit that file and run `npm run gen:waypoints` (from web/) — do not edit this file directly.
 */
...
export const WAYPOINTS = [
  ...
  },
  {
    ...
    description:
      "Home to Bruff GAA club, one of Ireland's oldest GAA clubs founded in 1887. The grounds host hurling and Gaelic football matches and have witnessed over 135 years of competitive Irish sport, including county championship games.",
    historicalInfo:
